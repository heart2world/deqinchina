...
<body>
	<div class="wrap js-check-wrap">
		<ul class="nav nav-tabs">
			...
			<li class="active"><a href="<?php echo U('SystemConfig/sensitive_word');?>">敏感词汇</a></li>
		...
		<div style="margin-top: 30px;">
			<div>
				<textarea id="text" style="width: 750px;height: 400px" placeholder='请输入敏感词汇，顿号"、"隔开即可...'><?php echo ($data['data']); ?></textarea>
			</div>
            ...
            $.ajax({
                ...
                success:function (res) {
                    if(res.code == 0){
                        ...
                        setTimeout(function(){
                            location.href='<?php echo U("sensitive_word");?>';
                        },1000);
                    } else {
