...
<body>
	<div class="wrap js-check-wrap">
		<ul class="nav nav-tabs">
			...
			<li class="active"><a href="<?php echo U('SystemConfig/app');?>">APP名称</a></li>
			<li><a href="<?php echo U('SystemConfig/game');?>">游戏PK设置</a></li>
		</ul>
		<div style="margin-top: 30px;">
			<div>
				<input type="text" id="app_name" placeholder="请输入APP名称" style="width: 500px;height: 40px"  value="<?php echo ($data); ?>">
			</div>
