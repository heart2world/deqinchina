...
<body>
	<div class="wrap" id="app">
		...
		<form method="post" class="form-horizontal" id="menuEdit">
			<fieldset>
			...
			<div class="form-actions">
				...
				<button type="button" class="btn btn-primary" @click="update()"><?php echo L('SAVE');?></button>
	...
	<script type="text/javascript">
        var app = new Vue({
            ...
            methods:{
                update:function () {
                    var dataValues=$('#menuEdit').serialize();
                    $.ajax({
                        type:'POST',
                        url:'<?php echo U("Admin/Menu/edit_post");?>',
                        data:dataValues,
                        dataType:'json',
                        success:function (res) {
                            if(res.rs == 0){
                                ...
                                setTimeout(function(){
                                    location.href='<?php echo U("Admin/Menu/index");?>';
                                },2000);
                            } else {
