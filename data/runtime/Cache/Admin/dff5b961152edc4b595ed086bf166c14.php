...
<body>
	<div class="wrap js-check-wrap">
		<ul class="nav nav-tabs">
			...
			<li class="active"><a href="<?php echo U('SystemConfig/protocol');?>">使用协议</a></li>
			<li><a href="<?php echo U('SystemConfig/app');?>">APP名称</a></li>
			<li><a href="<?php echo U('SystemConfig/game');?>">游戏PK设置</a></li>
		</ul>
		<div style="margin-top: 30px;">
			<div>
				<textarea id="text" style="width: 750px;height: 400px" placeholder='请输入使用协议'><?php echo ($data['data']); ?></textarea>
			</div>
	...
	<script type="text/javascript">
		function save() {
		    var protocol = $('#text').val();
            $.ajax({
                type:'POST',
                url:'<?php echo U("set_protocol");?>',
                ...
                success:function (res) {
                    if(res.code == 0){
                        ...
                        setTimeout(function(){
                            location.href='<?php echo U("protocol");?>';
                        },1000);
                    } else {
