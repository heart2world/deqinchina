...
<body>
	<div class="wrap js-check-wrap">
		<ul class="nav nav-tabs">
			...
			<li class="active"><a href="<?php echo U('Exam/category');?>">测评类型</a></li>
			<li><a href="<?php echo U('Exam/question');?>">试题库</a></li>
			<li><a href="<?php echo U('Exam/banner');?>">页面轮播图</a></li>
		</ul>
		<a class="btn btn-info" href="<?php echo U('Exam/cateadd');?>" style="margin-bottom: 16px;">新增类型</a>
			...
			<tbody>
				<?php if(is_array($cate)): foreach($cate as $key=>$vo): ?><tr>
					...
					<td>
						...
						<a class="label label-inverse" href='<?php echo U("Exam/catedit",array("id"=>$vo["id"]));?>'><?php echo L('EDIT');?></a>
					</td>
        ...
        function delete_cate(id) {
            $.dialog({
                ...
                ok: function(){
                    $.ajax({
                        type: 'POST',
                        url: '<?php echo U("Admin/Exam/cate_delete");?>',
                        data: {id:id},
                        dataType: 'json',
