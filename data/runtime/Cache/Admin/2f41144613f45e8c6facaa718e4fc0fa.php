...
<body>
	<div class="wrap js-check-wrap">
		<ul class="nav nav-tabs">
			<li class="active"><a href="<?php echo U('Exam/index');?>">在线测评</a></li>
        ...
        <form class="well form-search" method="post" action="<?php echo U('Exam/index');?>">
            测评:
            <input type="text" name="title" style="width: 100px;" value="<?php echo I('request.title/s','');?>" placeholder="输入测评标题">
			测评类型:
			<select name="cate_id">
            ...
            <a class="btn btn-info" href="<?php echo U('Exam/add');?>">新增测评</a>
		...
		<table class="table table-hover table-bordered">
			...
			<tbody>
				...
				<?php if(is_array($paper)): foreach($paper as $key=>$vo): ?><tr>
					...
					<td>
						<!--<a class="label label-inverse" href='<?php echo U("Exam/paper",array("id"=>$vo["id"]));?>'>添加试题</a>-->
						...
						<a class="label label-inverse" href='<?php echo U("Exam/examinfo",array("id"=>$vo["id"]));?>'>查看测评</a>
					</td>
