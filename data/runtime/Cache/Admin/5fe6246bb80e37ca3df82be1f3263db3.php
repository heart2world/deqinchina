...
<div class="wrap js-check-wrap" id="app">
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="<?php echo U('Bbs/carouseladd');?>">轮播图添加</a></li>
	</ul>
	<form id="carouselAdd" method="post" class="form-horizontal" enctype="multipart/form-data">
		<fieldset>
		...
		<div class="form-actions">
			<button class="btn btn-success" type="button" @click="add()"><?php echo L('SAVE');?></button>
		</div>
	</form>
</div>
...
<script type="text/javascript">
    ...
    var app = new Vue({
        ...
        methods:{
            add:function () {
                var dataValues=$('#carouselAdd').serialize();
                $.ajax({
                    type:'POST',
                    url:'<?php echo U("Admin/Bbs/carouseladd_post");?>',
                    data:dataValues,
                    dataType:'json',
                    success:function (res) {
                        if(res.rs == 0){
                            ...
                            setTimeout(function(){
                                location.href='<?php echo U("Admin/Bbs/carousel");?>';
                            },2000);
                        } else {
